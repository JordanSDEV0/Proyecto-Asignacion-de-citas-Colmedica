...
**/
@RestController
@RequestMapping("/appointmentsDoctorDate")
@CrossOrigin(origins = "*")
public class AppointmentDocDateCon {
/**
...
**/
    ...
    public ResponseEntity<? extends Object> getById(@PathVariable("id") String id){
        {
        try{
            return new ResponseEntity<>(appointmentService.getAllByDoctorDate(id), HttpStatus.OK);
