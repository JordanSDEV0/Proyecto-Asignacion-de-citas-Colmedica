...
**/
@RestController
@RequestMapping("/appointmentsPatientDate")
@CrossOrigin(origins = "*")

public class AppointmentPatDateCont {
/**
...
**/
    ...
    public ResponseEntity<? extends Object> getById(@PathVariable("id") String id){
        {
        try{
            return new ResponseEntity<>(appointmentService.getAllByPatientDate(id), HttpStatus.OK);
