...
public class DoctorService {
    ...
    /**
     * class creation DoctorDTO with attributes doctorDTO and exception
    ...
    public DoctorDTO create(DoctorDTO doctorDTO) throws IllegalArgumentException {
        if (userService.getById(doctorDTO.getId()) == null) {
            User newUser = userMapper.toUser(
                    userService.create(userMapper.toUserDTO(new User(doctorDTO.getId(), doctorDTO.getPassword()))));
            if (newUser != null) {
