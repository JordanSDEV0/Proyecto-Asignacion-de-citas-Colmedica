...
public class PatientService {
    ...
    /**
     * class creation PatientDTO with attributes patientDTO and exception
    ...
    public PatientDTO create(PatientDTO patientDTO) throws IllegalArgumentException {
        if (userService.getById(patientDTO.getId()) == null) {
            User newUser = userMapper.toUser(
                    userService.create(userMapper.toUserDTO(new User(patientDTO.getId(), patientDTO.getPassword()))));
            if (newUser != null) {
