...
/**
 * We create its attributes with their respective id and department with their respective types that are private
 */
    @Id
    ...
    **/
    private Integer id;
    /** 
    * Private attribute of String type with name departament
    **/
